...
@st.cache_resource
def load_model():
    # Load the model from the pickle file saved in the same directory as the script
...
def recommend_top_n(user_id, model, anime_df, rating_df, top_n=10):
    ...
    # Loop over each row and predict the rating
    ...
    # Get the top recommendations based on predicted ratings
...
with tab3:
    ...
    model = load_model()  # Loads the model from the .pkl file
